...
### Step 1: Create VPC and components
...
- We'll set CIDR block as 10.80.0.0/16 for our VPC. You can choose whatever you want. This gives us more than 65000 IP address. As you remember, after we set our CIDR block of our VPC, AWS couldn't expend it, we can just add new CIDR block.
    ...
    - So, now, we can create subnets. In this example, we are gonna create 2 public and 2 private subnets within 2 AZs. Each subnet's block must be covered by `10.80.0.0/16`. They are going to be /24 subnet masks. Subnet masks of Subnets can be shown on below; 
        - Public Subnets
          `10.80.10.0/24` `10.80.20.0/24` (This mask has 2 to the power of 8 IP addresses, we will be able to use 251 of them. Why? 
            ...
            2. Normally, I can attach totally 254 IPs for each subnet, when we create it outside. But, in AWS, 3 more IP addresses are reserved which are 
